...
1. **Alex Galentovsky** — 20335070
    + [BIOL343_CC](https://github.com/alexgalent/BIOL343_CC)
...
---------|--------------|------
population_type | sexual or asexual | categorical
ovary_width | width of flower's ovary | mm
ovary_height | height of flower's ovary | mm
flower_number | assigned # of individual flower | categorical
...
```{r import-clean}
cc1_data <- read.csv("data/A1_Data_Excel_New.csv")
...
$$
The units of the ovary area $mm^{2}$
...
knitr::kable(area_means, caption = "Mean Areas of Ovary Width by Population Type")
```
...
```{r area-histogram, include=TRUE, echo=FALSE}
library(ggplot2)
...
![*Solanum pompinellifolium*](images/Hydroponic_g13.jpg)
Source: [BIOL 343 Coding Challenge 2 on OnQ] Hydroponic_g13.jpg
